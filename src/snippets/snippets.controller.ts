...
class SnippetsController {
    ...
    public async newForm(req: Request, res: Response, next: NextFunction): Promise<void> {
        const languages = await languagesRepository.findAll();
        res.render('snippets/snippet_form', { languages });
    }

    public async newSnippet(req: Request, res: Response, next: NextFunction): Promise<void> {
        const result = validationResult(req);
    ...
    public async editForm(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    public async editSnippet(req: Request, res: Response, next: NextFunction): Promise<void> {
        const result = validationResult(req);
    ...
    public async deleteSnippet(req: Request, res: Response, next: NextFunction): Promise<void> {
        const snippetId = parseInt(req.params.id, 10);
